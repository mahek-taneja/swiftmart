...
<body>
    ...
    <main class="container py-4">
        ...
        <section class="my-5">
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="card product-card h-100">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="small text-muted mb-2"><?php echo htmlspecialchars($p['category']); ?> • ⭐
                                <?php echo number_format($p['rating'],1); ?></div>
                            <div class="mt-auto d-flex justify-content-between align-items-center">
                                <div class="price"><?php echo format_price_cents($p['price']); ?></div>
                                <a class="btn btn-sm btn-primary"
                                    href="<?php echo build_path('/customer/product.php?id=' . urlencode($p['id'])); ?>">View</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-3">
                <a class="btn btn-outline-primary" href="<?php echo build_path('/customer/listings.php'); ?>">View All
                    Products</a>
            </div>
        </section>
    </main>
