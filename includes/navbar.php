        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item"><a class="nav-link" href="<?php echo build_path('/customer/cart.php'); ?>"><i
                            class="bi bi-cart"></i> Cart <span class="badge text-bg-primary"
                            id="cart-count">0</span></a></li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                        aria-expanded="false">Vendor</a>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="<?php echo build_path('/vendor/login.php'); ?>">Login</a>
                        </li>
                        <li><a class="dropdown-item"
                                href="<?php echo build_path('/vendor/register.php'); ?>">Register</a></li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
                        <li><a class="dropdown-item"
                                href="<?php echo build_path('/vendor/dashboard.php'); ?>">Dashboard</a></li>
                    </ul>
                </li>
